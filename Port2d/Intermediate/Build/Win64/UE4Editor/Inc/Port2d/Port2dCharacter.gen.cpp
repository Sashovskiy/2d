...
// End Cross Module References
	static FName NAME_APort2dCharacter_BindFuckingFunc = FName(TEXT("BindFuckingFunc"));
	void APort2dCharacter::BindFuckingFunc()
	{
	...
	UFunction* Z_Construct_UFunction_APort2dCharacter_BindFuckingFunc()
	{
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_APort2dCharacter, "BindFuckingFunc", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x0C080C00, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
	...
	UFunction* Z_Construct_UFunction_APort2dCharacter_FShit()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_APort2dCharacter, "FShit", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04080401, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_APort2dCharacter()
	{
		...
		if (!OuterClass)
		{
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ArrayLadderAnimation_MetaData[] = {
				{ "Category", "Animations" },
				{ "ModuleRelativePath", "Port2dCharacter.h" },
			};
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_ArrayLadderAnimation = { UE4CodeGen_Private::EPropertyClass::Array, "ArrayLadderAnimation", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000005, 1, nullptr, STRUCT_OFFSET(APort2dCharacter, ArrayLadderAnimation), METADATA_PARAMS(NewProp_ArrayLadderAnimation_MetaData, ARRAY_COUNT(NewProp_ArrayLadderAnimation_MetaData)) };
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ArrayLadderAnimation_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "ArrayLadderAnimation", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UClass_UPaperFlipbook_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ArrayLadderAnimation,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ArrayLadderAnimation_Inner,
	...
	IMPLEMENT_CLASS(APort2dCharacter, 2174716315);
